...
NEEDS YOU: both meter readings, and the next Unreal run:
A. Go before Monday.
B. Hold until after Monday's reset.
C. Go from the reserve.
RECOMMENDATION B; A if comfortably under the ceiling; never C.
DEFAULT B.
DEADLINE 2026-09-06.

NEXT VISIBLE THING: the material's third status word, time unknown; then four Unreal frames, not flat grey.

BUDGET: unmeasured today; your reading predates this batch. Eight of ten points spent, reserve of six untouched.
