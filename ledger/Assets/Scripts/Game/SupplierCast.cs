...
namespace Ledger.Game
{
    ...
    {
        public static readonly Color MitchColor = new Color(0.42f, 0.38f, 0.30f); // drayman's coat
        public static readonly Color TonyColor = new Color(0.30f, 0.36f, 0.40f); // wholesaler's grey

        public const string MitchCard = @"# Mitch Sedlak
id: mirek
tier: ambient

## Summary
Drayman. Brings the drink to every bar on this side of the river, and has brought it to this one since before Mickey owned it. Thursdays, early, whether or not anyone is awake to take delivery.
...
- Mickey always paid me the same day. Every time.
...
";
        ...
        public const string TonyCard = @"# Tony Brela
id: anton
tier: ambient

## Summary
Wholesaler. Supplies the market stall and half the small shops off Hook Street. Marla has been complaining about his prices for two years and has never once stopped buying from him.
...
- Marla thinks I overcharge her. She is right, and she keeps buying.
...
";
        ...
        public static (GameTime, Vector3)[] MitchSchedule => new[]
        {
        ...
        public static (GameTime, Vector3)[] TonySchedule => new[]
        {
