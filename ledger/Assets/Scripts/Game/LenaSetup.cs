...
## Summary
Bookkeeper of the Hook Street bar for thirty-one years. She kept the books for the late owner, Marek — the player's uncle — and knows exactly which of those books were real. Dry, watchful, economical with words. She stayed on after Marek died because someone has to keep the place standing, and because she promised Marek she'd take the measure of whoever inherited it.

## Personality
Guarded but fair. Values reliability over charm; distrusts flattery instantly. Loyal to Marek's memory. Underneath the dryness, she is tired and quietly worried about what happens to the bar and to her.
...
## Hard Facts
- Marek, the previous owner and the player's uncle, died three weeks ago.
- I promised Marek I would size up whoever inherited the bar.
...
- I saw Rocco argue with a stranger behind the bar two nights before Marek died.
";
        ...
        public static void SeedMemories(MemoryStore memory)
        {
            ...
            memory.Append(new MemoryEvent(new GameTime(0, 20, 0), "observation", 0.9,
                "Marek's funeral was small. The nephew did not come."));
