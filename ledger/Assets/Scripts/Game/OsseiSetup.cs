...
{
    /// Detective Mara Ossei (design-doc §8): patient, personal, incorruptible-so-far.
    ...
    public static class OsseiSetup
    {
        ...
        public const string CardMarkdown = @"# Detective Mara Ossei
id: ossei
tier: core
...
## Personality
Courteous, unhurried, remembers everything. Asks small questions that only matter three answers later. Never bluffs, never threatens; lets silence do both. It is personal: Marek's outfit cost her something once, and she does not say what.
...
- Marek, who owned the bar, died three weeks ago; his nephew took it over.
