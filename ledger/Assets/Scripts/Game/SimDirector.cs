    ...
    public class SimDirector : MonoBehaviour
    {
        ...
        void Finish()
        {
            ...
            Debug.Log($"SimDirector: done. errors={_errors.Count} npcsMoved={npcsMoved} " +
                      ...
                      $"nameTagsOffered={NameTags.OfferedPeak} nameTagsHidden={NameTags.Suppressed} " +
                      ...
                      $"dressed={WorldBuilder.Dressed} doors={WorldBuilder.Doors} premises=[shop{WorldBuilder.PremisesBuilt[0]} house{WorldBuilder.PremisesBuilt[1]} tenement{WorldBuilder.PremisesBuilt[2]} shed{WorldBuilder.PremisesBuilt[3]}] perNear={perNear:0.00} perFar={perFar:0.00} " +
