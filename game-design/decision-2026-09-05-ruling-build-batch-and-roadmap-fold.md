...
- 095, the brief writes itself from repo state (today's is in the tree and
  ...
  reading that moves.
  CORRECTION 2026-09-06: passed the register as it stood on 2026-09-05, a host allowlist; refused under the link band Jafar ruled on 2026-09-06 (three repository links, none to the site); grandfathered by name, ruling of 6 September on the register's link band, section 5.
